...
#ifndef BASE_INCLUDE_UNIQUE_PTR_H
#define BASE_INCLUDE_UNIQUE_PTR_H
...
public:
    ...
    void swap(UniquePtr<T>& other) { std::swap_uptr(mPtr, other.mPtr); }
...
#endif  // PUBLIC_INCLUDE _UNIQUE_PTR_H
